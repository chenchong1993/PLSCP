...
<div class="row">
    <div class="map-col">
        <div id="map"></div>
        <h2 class="menu-btn" style="left: 43%;font-size: 35px;color: #0c0c0c;top: 10px">C7用户位置分布</h2>
        <button class="menu-btn" id="showRtTrailC7" onclick=showRtTrailC7()>查看C7用户实时轨迹</button>
        <button class="menu-btn" id="show331" onclick=show331()>查看331用户分布</button>
